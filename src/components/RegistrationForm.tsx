    ...
    return (
        <div className="absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[95dvh] sm:max-h-[90vh] overflow-hidden flex flex-col border border-gray-100">
                {/* Header */}
                <div className="bg-aa-green p-3 sm:p-4 border-b border-aa-green/10 flex justify-between items-center shrink-0">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.fullName ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.dateOfBirth ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.idNumber ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.phoneNumber ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.email ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.emergencyContactPhone ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                        placeholder="07XXXXXXXX"
                                    />
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all appearance-none cursor-pointer ${formErrors.preferredCourse ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                        >
                                ...
                                <div>
                                    <label htmlFor="preferredIntake" className="block text-xs font-semibold text-gray-700 mb-1.5 uppercase">
                                        {t('preferredIntake')} <span className="text-aa-green font-bold normal-case">(Wednesdays Only)</span>
                                    </label>
                                    <input
                                        id="preferredIntake"
                                        ...
                                        className={`w-full bg-slate-50 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 transition-all ${formErrors.preferredIntake ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-aa-green'}`}
                                    />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full bg-slate-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-aa-green/20 focus:border-aa-green transition-all"
                ...
                <div className="p-4 bg-gray-50 border-t border-gray-100 flex gap-3 shrink-0">
                    <button
                        type="button"
                        onClick={onCancel}
                        className="flex-1 px-4 py-3 text-sm font-semibold text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:text-aa-green hover:border-aa-green/30 transition-all shadow-sm active:scale-95 touch-manipulation"
                    >
                        {t('cancel')}
                    </button>
                    <button
                        ...
                        className="flex-1 px-4 py-3 text-sm font-bold text-white bg-aa-green rounded-xl hover:bg-aa-green/90 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all shadow-sm flex justify-center items-center active:scale-95 touch-manipulation"
                    >
                        {isSubmitting ? (
                            <>
